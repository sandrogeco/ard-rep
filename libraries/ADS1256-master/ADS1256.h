...
// Define PORT
#define PORT_DRDY PORTD // Pin 49 on Arduino Mega
#define PIN_DRDY PIND
#define PINDEX_DRDY PD1
#define DDR_DRDY DDRD

#define PORT_CS PORTG // Pin 53 on Arduino Mega
#define PIN_CS PING
#define PINDEX_CS PG5
#define DDR_CS DDRG

#define PORT_RESET PORTD // PIN 48 on Arduino Mega
